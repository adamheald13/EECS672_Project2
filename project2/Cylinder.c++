...
Cylinder::Cylinder(float x, float y, float z, float rotx, float roty, float rotz, float length) : displayCylEdges(false), displayCylFill(true)
{
	defineCylinder(x, y, z, rotx, roty, rotz, length);
}
...
void Cylinder::defineCylinder(float x, float y, float z, float rotx, float roty, float rotz, float length)
{
