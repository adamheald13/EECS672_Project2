...
void Support::create()
{
	...
	Cylinder* vertSupport = new Cylinder(cylinderX, cylinderY, cylinderZ, 0, cylinderAngle, 0, 3);
	...
	for(int i = 0; i < 180; i++)
	{
		...
		Cylinder* cylinder = new Cylinder(cylinderX, cylinderY, cylinderZ, 0, cylinderAngle, 0, .01);
		models.push_back(cylinder);
	}

	Cylinder* horizSupport = new Cylinder(cylinderX + horizModifier, 7.62, 3, 0, 0, 0, 2.2192);
