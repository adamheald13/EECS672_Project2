...
{
public:
	Cylinder(float x, float y, float z, float rotx, float roty, float rotz, float length);
	virtual ~Cylinder();
...
private:
	...
	void defineCylinder(float x, float y, float z, float rotx, float roty, float rotz, float length);
